export default function IntroPage() {
  return (
    <>
      ...
      <p>채팅은 화면 디자인까지 끝냈으며 개발 진행중입니다.</p>
      ...
      <ol>
        ...
        <li>2. 소셜로그인 (검증 후 미가입 회원이면 회원가입페이지 리다이렉트 후 가입)</li>
        <li>3. 테스트 로그인</li>
        <li>4. 회원가입 페이지, 마이페이지 (컴포넌트 재활용)</li>
      ...
      <ol>
        ...
        <li>3. 채널검색 (엘서 오토컴플리트)</li>
        <li>4. 멘토등록 멘티등록</li>
        <li>5. 채널초대, 나가기, 내보내기</li>
        <li>6. 디엠</li>
      </ol>
      <ol>
        <h4>3단계: 배포 (완료)</h4>
